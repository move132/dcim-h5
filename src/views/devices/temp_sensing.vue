<template>
    ...
    <div class="power">
        <div class="power-list">
            <div class="tag">
                <div>正常<img src="../../assets/device/sensing_nomal.png" alt /></div>
                <div>报警<img src="../../assets/device/sensing_warn.png" alt /></div>
            </div>
...
.deviceimg-wrap {
    ...
    .point {
        ...
        margin-top: 20px;
        &.nomal {
            background: url(../../assets/device/sensing_nomal.png) no-repeat;
            background-size: 100% 100%;
        }
        &.warn {
            background: url(../../assets/device/sensing_warn.png) no-repeat;
            background-size: 100% 100%;
        }
        span {
            color: #fff;
